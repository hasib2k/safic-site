...
export default function Home() {
  ...
  return (
    <div>
      ...
      {/* About */}
      <section id="about" className="welcome" style={{ paddingTop: 28, paddingBottom: 18, background: '#f8fafc' }}>
      ...
      <section id="prayer" className="prayer" style={{ paddingTop: 10, paddingBottom: 28, background: '#f8fafc' }}>
  ...
  <div className="prayer-grid" style={{ marginTop: 10 }}>
      ...
      {/* Events & Programs */}
  <section id="events" className="events" style={{ marginTop: -48, background: '#f8fafc', padding: '36px 0' }}>
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: 18 }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 8 }}>
      ...
      {/* Latest News grid */}
      <section id="news" className="news" style={{ background: '#f8fafc', padding: '36px 0' }}>
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: 18 }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 8 }}>
      ...
      <section id="donation" className="donation" style={{ paddingBottom: '20px', background: '#f8fafc' }}>
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: 18 }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 8 }}>
          ...
          <div className="donation-grid" style={{ display: 'grid', gridTemplateColumns: '1fr', gap: 24 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: 16 }}>
              ...
              <div>
                <h4 style={{ margin: '12px 0 8px 0', color: '#c19233' }}>Bank Transfer — Meghna Bank (Account Details)</h4>
      ...
      {/* Gallery */}
      <section id="gallery" className="gallery" style={{ background: '#f8fafc', padding: '20px 0 60px 0' }}>
